      ...
      <div className="max-w-6xl mx-auto px-5 pt-28 pb-20">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 gap-4">
          ...
          <motion.button
            ...
            onClick={refresh}
            className="flex items-center gap-2 px-4 py-2.5 rounded-lg bg-white/[0.03] border border-white/[0.08] text-gray-400 hover:text-white hover:border-white/[0.15] transition-all text-sm font-medium"
          >
